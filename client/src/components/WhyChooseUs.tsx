    ...
    <section className="py-16 bg-background">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <h2 className="text-3xl sm:text-4xl font-bold text-foreground mb-4" data-testid="text-whychoose-title">
            {t('whyChoose.title')}
          </h2>
          ...
          {benefits.map((benefit, index) => {
            ...
            return (
              ...
              >
                ...
                <h3 className="text-xl font-bold text-foreground mb-3" data-testid={`${benefit.testId}-title`}>
                  {benefit.title}
                </h3>
