          ...
          {badges.map((badge, index) => {
            ...
            return (
              ...
              >
                ...
                <h3 className="text-lg font-semibold text-foreground" data-testid={`${badge.testId}-title`}>
                  {badge.title}
                </h3>
                <p className="text-sm text-muted-foreground" data-testid={`${badge.testId}-description`}>
                  {badge.description}
                </p>
              </div>
            );
