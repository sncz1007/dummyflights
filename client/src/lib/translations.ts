export const translations = {
  en: {
    ...
    'hero.guarantee': 'Real Flights • Booking Code (PNR) • Ticket Number (ETKT) • Receipt • Instant Download',
    ...
    'testimonials.customer2.name': 'Manuel Mendez',
    'testimonials.customer2.location': 'Mexico City, Mexico',
    'testimonials.customer2.text': 'Downloaded my dummy ticket instantly. The booking code and ticket number worked perfectly for my USA visa application at the embassy. Real flight data from actual airlines made all the difference!',
    'testimonials.customer3.name': 'Carlos Fuentes',
    'testimonials.customer3.location': 'Madrid, Spain',
    ...
    'faq.q1.answer': 'A dummy ticket is a valid flight reservation that looks like a regular airline ticket and includes booking codes and ticket numbers from real existing flights. Our dummy tickets use real flight data from official airline databases.',
    ...
    'faq.q3.answer': 'After completing your payment, your dummy ticket will be automatically generated with a booking code, ticket number, and real information from the selected flight, as well as a purchase receipt. You can download them immediately in PDF format.',
    ...
    'terms.services.p3': 'Additionally, we respect your privacy and are available to answer any questions you may have during the process, by email. Your purchase is protected and backed by trusted technology. What payment methods do we accept? We accept credit or debit card payments. All payments are secure.',
  ...
  es: {
    ...
    'hero.guarantee': 'Vuelos Reales • Codigo de Reserva (PNR) • Numero de Tiquete (ETKT) • Factura • Descarga Inmediata',
    ...
    'testimonials.customer2.name': 'Manuel Méndez',
    'testimonials.customer2.location': 'Ciudad de México, México',
    'testimonials.customer2.text': 'Descargué mi tiquete ficticio al instante. El código de reserva y número de ticket funcionaron perfectamente para mi solicitud de visa estadounidense en la embajada. ¡Los datos de vuelo reales de las aerolíneas marcaron la diferencia!',
    'testimonials.customer3.name': 'Carlos Fuentes',
    'testimonials.customer3.location': 'Madrid, España',
    ...
    'faq.q1.answer': 'Un tiquete ficticio es una reserva de vuelo válida que tiene el aspecto de un billete de aerolínea normal e incluye códigos de reserva y números de ticket de vuelos reales existentes. Nuestros tiquetes ficticios usan datos de vuelos reales de bases de datos oficiales de las aerolíneas.',
    ...
    'faq.q3.answer': 'Después de completar tu pago, automáticamente se generará tu tiquete ficticio con un código de reserva, numero de Ticket e información real del vuelo seleccionado, así como una factura de compra. Podrás descargarlos de inmediato en formato PDF.',
    ...
    'terms.services.p1': 'Flights Dummys proporciona tiquetes ficticios de vuelo (también conocidos como reservas de vuelo o itinerarios) con datos de vuelo reales de bases de datos reales de aerolíneas. Nuestros tiquetes ficticios incluyen códigos de reserva y números de ticket de vuelos reales existentes. ¿Es seguro comprar con nosotros? Comprar con nosotros es completamente seguro, ya que procesamos todos los pagos, con los más altos estándares de seguridad. Una vez selecciones los detalles de tu vuelo, proporciones toda la información requerida y realices el pago seguro, automáticamente se generará tu tiquete ficticio con códigos de reserva y números de ticket. Asi como una factura de compra que podrás descargar de inmediato en formato PDF.',
    ...
    'terms.services.p3': 'Además, respetamos tu privacidad y estamos disponibles para responder cualquier pregunta que puedas tener durante el proceso, por correo electrónico. Tu compra está protegida y respaldada por tecnología confiable. ¿Qué métodos de pago aceptamos? Aceptamos pagos con tarjeta de crédito o débito. Todos los pagos son seguros.',
