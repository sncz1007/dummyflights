export const translations = {
  en: {
    ...
    // Trust Badges
    'trust.secureBooking': 'Verifiable PNR',
    'trust.secureBookingDesc': 'Valid 6-digit alphanumeric codes verifiable on airline websites',
    ...
    'about.description': 'A dummy ticket looks like a regular flight ticket and includes a valid 6-digit alphanumeric booking code (PNR) provided by the airline. The PNR code can be verified on the airline\'s website in the "Manage My Booking" or "My Trips" section. A dummy ticket is also known as a flight reservation or itinerary. We provide dummy tickets with real flight data from the Amadeus global database, ensuring authenticity for visa applications, proof of return, passport renewal, HR documentation, and more.',
    ...
    'deals.flash.title': 'Verifiable PNR Codes',
    'deals.flash.description': 'Every dummy ticket includes a valid 6-digit alphanumeric PNR code that can be verified on airline websites.',
    'deals.flash.cta': 'Get Dummy Ticket',
    'deals.earlybird.title': 'Real Flight Data',
    'deals.earlybird.description': 'All dummy tickets use authentic flight information from the Amadeus global database for maximum credibility.',
    ...
    'testimonials.customer1.text': 'I needed a dummy ticket for my Schengen visa application. The PNR code was verified instantly on the airline website. My visa was approved! Highly recommend SkyBudgetFly!',
    'testimonials.customer2.name': 'Carlos Mendez',
    'testimonials.customer2.location': 'Mexico City, Mexico',
    'testimonials.customer2.text': 'Got my dummy ticket in less than 2 hours. The PNR worked perfectly for my USA visa application at the embassy. Real flight data from Amadeus made all the difference!',
    ...
    'testimonials.customer4.text': 'Fast and reliable! I used the dummy ticket to speed up my passport renewal. The verifiable PNR code and real flight details made the process smooth. Great support team too!',
    ...
    'faq.q1.answer': 'A dummy ticket is a valid flight reservation that looks like a regular airline ticket and includes a verifiable 6-digit alphanumeric booking code (PNR). The PNR can be verified on the airline\'s website under "Manage My Booking" or "My Trips". Our dummy tickets use real flight data from the Amadeus global database.',
    'faq.q2.question': 'Can the PNR code be verified?',
    'faq.q2.answer': 'Yes! Every dummy ticket includes a valid PNR code that can be verified directly on the airline\'s official website. This makes our dummy tickets acceptable for visa applications, immigration, and other official purposes that require proof of travel.',
    ...
    'faq.q6.answer': 'Our dummy tickets contain real flight information from actual airline schedules via the Amadeus database, and include valid PNR codes. However, they are not actual flight tickets and cannot be used to board a plane. They are for documentation purposes only, such as visa applications and proof of travel intent.',
    
    // Contact
    'contact.title': 'Need a Dummy Ticket?',
    'contact.subtitle': 'Get your dummy ticket with verifiable PNR code and real flight data for visa applications and more',
    ...
    'terms.services.p1': 'SkyBudgetFly provides dummy flight tickets (also known as flight reservations or itineraries) with real flight data from the Amadeus global database. Our dummy tickets include valid 6-digit alphanumeric booking codes (PNR) that can be verified on airline websites. Is it safe to buy with us? Purchasing with us is completely safe, as we process all payments through Stripe, an internationally verified platform that protects your money with the highest security standards. Once you select your flight details, provide all required information, and make the secure payment through Stripe, our team will generate your dummy ticket with a valid PNR code. We will then send the dummy ticket in PDF format to your email.',
    ...
    'terms.quotes.text': 'A dummy ticket is a valid flight reservation that includes real flight information from the Amadeus global database and a verifiable PNR code. The PNR can be checked on the airline\'s official website under "Manage My Booking" or "My Trips". Dummy tickets are used for visa applications, proof of return travel, passport renewal, HR documentation, and other official purposes. Important: Dummy tickets are NOT actual flight tickets and cannot be used to board a plane - they are for documentation purposes only.',
    'terms.booking.title': 'Purchase Process',
    'terms.booking.text': 'Select your desired flight from our real-time search results powered by the Amadeus database. After selecting your flight, provide your passenger information and complete the secure payment through Stripe. Once payment is confirmed, we will generate your dummy ticket with a valid PNR code and real flight details. You will receive your dummy ticket in PDF format via email within a maximum of 8 hours.',
    ...
    'toast.successMessage': 'Your dummy ticket request has been submitted. We\'ll process your order and send your dummy ticket with valid PNR code within 8 hours!',
    'toast.error': 'Error',
  ...
  es: {
    ...
    // Trust Badges
    'trust.secureBooking': 'PNR Verificable',
    'trust.secureBookingDesc': 'Códigos alfanuméricos de 6 dígitos válidos verificables en sitios web de aerolíneas',
    ...
    'about.description': 'Un tiquete ficticio tiene el aspecto de un billete de avión normal e incluye un código de reserva (PNR) válido de 6 dígitos alfanuméricos proporcionado por la aerolínea. El código PNR se puede verificar en la página web de la aerolínea, en la sección "Gestionar mi reserva" o "Mis viajes". Un tiquete ficticio también se conoce como reserva de vuelo o itinerario. Proporcionamos tiquetes ficticios con datos de vuelos reales de la base de datos global de Amadeus, garantizando autenticidad para solicitudes de visa, comprobante de regreso, renovación de pasaporte, documentación de RR.HH., y más.',
    ...
    'deals.flash.title': 'Códigos PNR Verificables',
    'deals.flash.description': 'Cada tiquete ficticio incluye un código PNR válido de 6 dígitos alfanuméricos que se puede verificar en sitios web de aerolíneas.',
    'deals.flash.cta': 'Obtener Tiquete Ficticio',
    'deals.earlybird.title': 'Datos de Vuelo Reales',
    'deals.earlybird.description': 'Todos los tiquetes ficticios usan información de vuelo auténtica de la base de datos global de Amadeus para máxima credibilidad.',
    ...
    'testimonials.customer1.name': 'Sarah Johnson',
    'testimonials.customer1.location': 'Miami, USA',
    'testimonials.customer1.text': 'Necesitaba un tiquete ficticio para mi solicitud de visa Schengen. El código PNR se verificó instantáneamente en el sitio web de la aerolínea. ¡Mi visa fue aprobada! ¡Muy recomendado!',
    'testimonials.customer2.name': 'Carlos Méndez',
    'testimonials.customer2.location': 'Ciudad de México, México',
    'testimonials.customer2.text': 'Recibí mi tiquete ficticio en menos de 2 horas. El PNR funcionó perfectamente para mi solicitud de visa estadounidense en la embajada. ¡Los datos de vuelo reales de Amadeus marcaron la diferencia!',
    'testimonials.customer3.name': 'Yuki Tanaka',
    ...
    'testimonials.customer4.name': 'Emma Williams',
    'testimonials.customer4.location': 'New York, USA',
    'testimonials.customer4.text': '¡Rápido y confiable! Usé el tiquete ficticio para acelerar mi renovación de pasaporte. El código PNR verificable y los detalles de vuelo reales hicieron el proceso fluido. ¡Gran equipo de soporte también!',
    ...
    'faq.q1.answer': 'Un tiquete ficticio es una reserva de vuelo válida que tiene el aspecto de un billete de aerolínea normal e incluye un código de reserva (PNR) verificable de 6 dígitos alfanuméricos. El PNR se puede verificar en el sitio web de la aerolínea en "Gestionar mi reserva" o "Mis viajes". Nuestros tiquetes ficticios usan datos de vuelo reales de la base de datos global de Amadeus.',
    'faq.q2.question': '¿Se puede verificar el código PNR?',
    'faq.q2.answer': '¡Sí! Cada tiquete ficticio incluye un código PNR válido que se puede verificar directamente en el sitio web oficial de la aerolínea. Esto hace que nuestros tiquetes ficticios sean aceptables para solicitudes de visa, inmigración y otros fines oficiales que requieren comprobante de viaje.',
    ...
    'faq.q6.answer': 'Nuestros tiquetes ficticios contienen información de vuelo real de los horarios de aerolíneas reales a través de la base de datos de Amadeus, e incluyen códigos PNR válidos. Sin embargo, no son tiquetes de vuelo reales y no se pueden usar para abordar un avión. Son solo para fines de documentación, como solicitudes de visa y comprobante de intención de viaje.',
    
    // Contact
    'contact.title': '¿Necesitas un Tiquete Ficticio?',
    'contact.subtitle': 'Obtén tu tiquete ficticio con código PNR verificable y datos de vuelo reales para solicitudes de visa y más',
    ...
    'terms.services.p1': 'SkyBudgetFly proporciona tiquetes ficticios de vuelo (también conocidos como reservas de vuelo o itinerarios) con datos de vuelo reales de la base de datos global de Amadeus. Nuestros tiquetes ficticios incluyen códigos de reserva (PNR) válidos de 6 dígitos alfanuméricos que se pueden verificar en los sitios web de las aerolíneas. ¿Es seguro comprar con nosotros? Comprar con nosotros es completamente seguro, ya que procesamos todos los pagos a través de Stripe, una plataforma verificada internacionalmente que protege tu dinero con los más altos estándares de seguridad. Una vez selecciones los detalles de tu vuelo, proporciones toda la información requerida y realices el pago seguro mediante Stripe, nuestro equipo generará tu tiquete ficticio con un código PNR válido. Luego enviaremos el tiquete ficticio en formato PDF a tu correo electrónico.',
    ...
    'terms.quotes.text': 'Un tiquete ficticio es una reserva de vuelo válida que incluye información de vuelo real de la base de datos global de Amadeus y un código PNR verificable. El PNR se puede verificar en el sitio web oficial de la aerolínea en "Gestionar mi reserva" o "Mis viajes". Los tiquetes ficticios se utilizan para solicitudes de visa, comprobante de regreso, renovación de pasaporte, documentación de RR.HH. y otros fines oficiales. Importante: Los tiquetes ficticios NO son billetes de avión reales y no se pueden usar para abordar un avión - son solo para fines de documentación.',
    'terms.booking.title': 'Proceso de Compra',
    'terms.booking.text': 'Selecciona tu vuelo deseado de nuestros resultados de búsqueda en tiempo real alimentados por la base de datos de Amadeus. Después de seleccionar tu vuelo, proporciona la información del pasajero y completa el pago seguro a través de Stripe. Una vez confirmado el pago, generaremos tu tiquete ficticio con un código PNR válido y detalles de vuelo reales. Recibirás tu tiquete ficticio en formato PDF por correo electrónico dentro de un máximo de 8 horas.',
    ...
    // Toast Messages
    'toast.success': '¡Éxito!',
    'toast.successMessage': 'Tu solicitud de tiquete ficticio ha sido enviada. Procesaremos tu orden y enviaremos tu tiquete ficticio con código PNR válido en un máximo de 8 horas!',
    'toast.error': 'Error',
