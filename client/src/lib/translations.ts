export const translations = {
  en: {
    ...
    'terms.services.p2': 'The estimated delivery time is from a few minutes to a maximum of 8 hours, depending on our team\'s booking demand, but we will notify you as soon as we receive and verify your payment to guarantee that we are already working on your reservation. Additionally, we respect your privacy and are available to answer any questions you may have during the process, either by email or through our integrated website chat. Your purchase is protected and backed by trusted technology. What payment methods do we accept? We accept credit or debit card payments, bank transfers, and through our secure Stripe platform. All payments are secure.',
