export const translations = {
  en: {
    ...
    'faq.q5.answer': 'For domestic USA flights, we have a partnership with Alaska Airlines and American Airlines. For international routes, we work with British Airways, Cathay Pacific, Fiji Airways, Finnair, Iberia, Japan Airlines, Malaysia Airlines, Oman Air, Qantas, Qatar Airways, Royal Air Maroc, Royal Jordanian, and SriLankan Airlines.',
