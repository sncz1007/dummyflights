export const translations = {
  en: {
    ...
    'faq.q3.answer': 'After completing your payment, our team takes care of making the reservation by manually purchasing your tickets from the airline, which is necessary to access the % discount offered by SkyBudgetFly. You will receive your e-tickets or reservation code(s) via email.||The estimated delivery time is from a few minutes to a maximum of no more than 8 hours, depending on our team\'s booking demand, but we will notify you as soon as we receive and verify your payment to guarantee that we are already working on your reservation.',
    'faq.q4.question': 'Can I cancel or modify my booking?',
    'faq.q4.answer': 'Our commitment to fulfilling our customers\' needs is very important to us, therefore for modifications or itinerary changes please contact our support team at least 48 hours before your flight, which is the time stipulated by airlines for us to be able to assist you.||Regarding cancellation and refund policies: SkyBudgetFly makes it clear in its terms and conditions that due to the discount offered on each flight which includes taxes and service fees, we cannot process refunds, so we recommend that customers be sure before making their reservation. However, we can offer you to change your flight if you notify us in advance.',
    'faq.q5.question': 'Which airlines are included?',
    'faq.q5.answer': 'For domestic USA flights, we have a partnership with Alaska Airlines and American Airlines. For international routes, we work with Aer Lingus, British Airways, Cathay Pacific, Condor, Fiji Airways, Finnair, Hawaiian Airlines, Icelandair, Porter Airlines Inc, Porter Airlines Inc, Qantas, Qatar Airways, Royal Air Maroc, Starlux Airlines.',
    ...
    'terms.services.p1': 'SkyBudget offers assistance services for flight search and booking. We act as intermediaries between customers and airlines. Is it safe to buy with us? Booking with us is completely safe, as we process all payments through Stripe, an internationally verified platform that protects your money with the highest security standards. Once you select your flight details, provide all required information, and make the secure payment through Stripe, our team will proceed to verify and subsequently book with the selected airlines using our partner codes to access the offered discount. We will then send the reservation code(s) or digital tickets to your email.',
    'terms.services.p2': 'The estimated delivery time is from a few minutes to a maximum of 8 hours, depending on our team\'s booking demand, but we will notify you as soon as we receive and verify your payment to guarantee that we are already working on your reservation.',
    ...
    'terms.quotes.text': 'Currently, we have agreements with airlines that are members of the Oneworld alliance for domestic and international flights. Quotes are made in real time and offer flight prices by analyzing different routes and different airlines to offer you a better price, in addition to automatically applying the discount percentage offered by SkyBudgetFly.',
    ...
    'terms.cancellation.p1': 'Our commitment to fulfilling our customers\' needs is very important to us, therefore for modifications or itinerary changes please contact our support team at least 48 hours before your flight, which is the time stipulated by airlines for us to be able to assist you.',
    'terms.cancellation.p2': 'Regarding cancellation and refund policies: SkyBudgetFly makes it clear that due to the discount offered on each flight which includes taxes and service fees, we cannot process refunds, so we recommend that customers be sure before making their reservation. However, we can offer you to change your flight if you notify us in advance. Contact us for more information.',
  ...
  es: {
    ...
    'faq.q3.answer': 'Después de completar tu pago, nuestro equipo se encarga de realizar la reserva comprando manualmente tus boletos con la aerolínea, lo cual es necesario para acceder al % de descuento ofrecido por SkyBudgetFly. Recibirás tus e-tickets o codigo(s) de reserva por correo electrónico.||El tiempo estimado de entrega es de unos minutos a un tiempo máximo no superior a 8 horas, esto según la demanda de reservas que tenga nuestro equipo, pero te notificaremos tan pronto recibamos y verifiquemos tu pago para darte la garantía de que ya estamos trabajando en tu reserva.',
    'faq.q4.question': '¿Puedo cancelar o modificar mi reserva?',
    'faq.q4.answer': 'Nuestro compromiso con cumplirle a nuestros clientes es muy importante para nosotros, por eso para modificaciones o cambio de itinerario por favor contacta a nuestro equipo de soporte al menos 48 horas antes de tu vuelo, que es el tiempo que estipulan las aerolíneas para que podamos ayudarte.||En cuanto a las políticas de cancelación y reembolso: SkyBudgetFly deja en claro en sus términos y condiciones que por razones del descuento ofrecido en cada vuelo en el cual vienen incluidos impuestos y gastos de servicio, no podemos realizar devoluciones de dinero, así que recomendamos a los clientes estar seguros de realizar su reserva. Lo que si te podemos ofrecer es cambiar tu vuelo si nos avisas con anticipación.',
    ...
    'terms.services.p1': 'SkyBudget ofrece servicios de asistencia para búsqueda y reserva de vuelos. Actuamos como intermediarios entre clientes y aerolíneas. ¿Es seguro comprar con nosotros? Reservar con nosotros es completamente seguro, ya que procesamos todos los pagos a través de Stripe, una plataforma verificada internacionalmente que protege tu dinero con los más altos estándares de seguridad. Una vez selecciones los detalles de tu vuelo, proporciones todos los datos requeridos y realices el pago seguro mediante Stripe, nuestro equipo procederá a hacer la verificación y posteriormente a reservar ante las aerolíneas seleccionadas con nuestros códigos de asociados para acceder a el descuento ofrecido. Para después enviar a tu correo el código(s) de reserva o en su defecto los ticketes digitales.',
    'terms.services.p2': 'El tiempo estimado de entrega es de unos minutos a un tiempo máximo no superior a 8 horas, esto según la demanda de reservas que tenga nuestro equipo, pero te notificaremos tan pronto recibamos y verifiquemos tu pago para darte la garantía de que ya estamos trabajando en tu reserva.',
    ...
    'terms.quotes.text': 'Actualmente, tenemos acuerdos con aerolíneas que son miembros de la alianza Oneworld para vuelos domésticos e internacionales. Las cotizaciones se hacen en tiempo real y ofrecen precios de vuelos analizando distintas rutas y distintas aerolíneas para ofrecerte un mejor precio, además de que automáticamente se le aplica el % de descuento que ofrece SkyBudgetFly.',
    ...
    'terms.cancellation.p1': 'Nuestro compromiso con cumplirle a nuestros clientes es muy importante para nosotros, por eso para modificaciones o cambio de itinerario por favor contacta a nuestro equipo de soporte al menos 48 horas antes de tu vuelo, que es el tiempo que estipulan las aerolíneas para que podamos ayudarte.',
    'terms.cancellation.p2': 'En cuanto a las políticas de cancelación y reembolso: SkyBudgetFly deja en claro que por razones del descuento ofrecido en cada vuelo en el cual vienen incluidos impuestos y gastos de servicio, no podemos realizar devoluciones de dinero, así que recomendamos a los clientes estar seguros de realizar su reserva. Lo que si te podemos ofrecer es cambiar tu vuelo si nos avisas con anticipación. Contáctanos para mas información.',
